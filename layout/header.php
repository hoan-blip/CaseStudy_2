                        ...
                        <div class="menu-area">
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="shop.php">Product<i class="fa fa-angle-down"></i></a>
                                        <!-- <div class="sub-menu sub-menu-2">
                                           
                                        </div> -->
                                    </li>
                                    <li><a href="cart.php">Cart<i class="fa fa-angle-down"></i></a>
                                        <!-- <div class="sub-menu sub-menu-2">
                                            
                                        </div> -->
                                    </li>
                                    <li><a href="contact.php">Contact Us<i class="fa fa-angle-down"></i></a>
                                        <!-- <div class="sub-menu sub-menu-2">
